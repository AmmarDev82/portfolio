...
const Home = () => {
	...
	const whatsappNumber = '923068430259'; // Formatted for WhatsApp URL

	// Updated to your GitHub username
	const { data: githubData } = useSWR('https://api.github.com/users/AmmarDev82', fetcher);
	...
	return (
		<>
			<SEO
				title="Ammar Shahbaz - Software Engineer & Master's Aspirant"
			...
			<div className="min-h-screen flex items-center justify-center px-4 mt-16 sm:mt-0 md:mt-3 lg:mt-5">
				<div className="text-center relative z-10 max-w-4xl mx-auto mt-[88px]">
					<motion.h1
					...
					<motion.h1
						className="text-2xl sm:text-4xl md:text-6xl font-bold mb-4 sm:mb-6 relative tracking-tighter text-gray-200"
						initial={{ opacity: 0, y: 20 }}
						animate={{ opacity: 1, y: 0 }}
						transition={{ duration: 0.8 }}
					>
					...
					>
						Software Engineer specializing in Full Stack Development and System Design. Leveraging 3+ years of industrial experience to pursue advanced academic research in Germany.
					</motion.p>
					...
					>
						...
						<motion.a
							href="https://linkedin.com/in/ammar-shahbaz-dev/"
							target="_blank"
							rel="noopener noreferrer"
							className="flex flex-col items-center group w-full"
							whileHover={{ y: -2 }}
