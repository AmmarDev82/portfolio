                    ...
                    <table class="container" border="0" cellpadding="0" cellspacing="0" width="600">
                        ...
                        <tr>
                            <td class="header" align="center">
                                <img src="http://Ammar Shahbaz.kyakabi.com/profile/ibd.png" alt="Ammar Shahbaz Abdallah Kato Portfolio" width="564" style="display: block; max-width: 100%;">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="content">
                                ...
                                <p class="text-center" style="text-align: center;">
                                    Ammar Shahbaz Abdallah Kato Portfolio<br>
                                    a.Ammar Shahbaz@kyakabi.com
                                </p>
                                
                                <p>Hello Ammar Shahbaz,</p>
                        ...
                        <tr>
                            <td class="footer">
                                <p><strong>Ammar Shahbaz ABDALLAH KATO</strong><br>
                                Software Developer based in Kampala, Uganda<br>
                                a.Ammar Shahbaz@kyakabi.com | +256701019242</p>
                                
                                <!-- Social Icons -->
                                <div class="social-icons">
                                    <a href="https://www.facebook.com/abdallahAmmar Shahbaz.kato/" target="_blank">
                                    ...
                                    <a href="https://Ammar Shahbaz.kyakabi.com/projects" target="_blank">
                                    ...
                                    <a href="https://github.com/abdallahAmmar Shahbazkato" target="_blank">
...
<body style="margin: 0; padding: 0; background-color: #f1f5f8;">
                    ...
                    <table class="container" border="0" cellpadding="0" cellspacing="0" width="600">
                        ...
                        <tr>
                            <td class="content">
                                ...
                                <p class="text-center" style="text-align: center;">
                                    Ammar Shahbaz Abdallah Kato - Software Developer<br>
                                ...
                                <ul>
                                    <li>View my <a href="https://Ammar Shahbaz.kyakabi.com/projects">recent projects</a></li>
                                    <li>Check out my <a href="https://Ammar Shahbaz.kyakabi.com/skills">technical skills</a></li>
                                    <li>See my professional <a href="https://Ammar Shahbaz.kyakabi.com/certificates">certifications</a></li>
                                </ul>
                                ...
                                <p>Best regards,<br>
                                <strong>Ammar Shahbaz Abdallah Kato</strong><br>
                        ...
                        <tr>
                            <td class="footer">
                                ...
                                <p>a.Ammar Shahbaz@kyakabi.com | +256701019242</p>
                                ...
                                <p style="font-size: 10px;">
                                    &copy; ${currentYear} Ammar Shahbaz Abdallah Kato. All rights reserved.
                                </p>
                            </td>
                        </tr>
                    </table>
    ...
    await transporter.sendMail({
      from: `"Ammar Shahbaz Abdallah Kato" <${process.env.FROM_EMAIL}>`,
      to: email,
      subject: 'Message Received - Ammar Shahbaz Abdallah Kato',
